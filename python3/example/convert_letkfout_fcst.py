...
varout_3d = ['u', 'v', 'w', 'p', 'tk', 'theta', 'z', 'qv', 'qc', 'qr', 'qi', 'qs', 'qg', 'qhydro', 'rh', 'dbz']  # all available output 3D variables for history file
varout_2d = ['topo', 'slp', 'u10', 'v10', 'uabs10', 't2', 'q2', 'rain', 'snow', 'prec', 'max_dbz',               # all available output 2D variables for history file
             'olr', 'osr', 'slr', 'ssr', 'sflx_lw_dn', 'sflx_sw_dn', 'tsfc', 'tsfcocean', 'sst', 'glon', 'glat'] #
proj = {
'type': 'LC',
